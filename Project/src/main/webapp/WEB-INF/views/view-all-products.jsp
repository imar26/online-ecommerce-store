...
<body>
	...
	<form>
		<p>
			Search Products: <input type="text" name="search" id="search" />
		</p>
	</form>
	<form>
		<p>
						...
						<div class="col-md-6">
							<div class="w3-container">
								<div class="w3-panel w3-card-4">
									<div>
										<img src="${product.fileName}" width="100%" height="150"
											style="padding: 10px 0 5px 0; object-fit: cover;" /> <br />
										<h1>
											<a href="single-product.htm?id=${product.productID }">${product.productName }</a>
										</h1>
										...
										<p>
											<b>Sold By: </b><i>${product.seller.companyName}</i>
										</p>
									</div>
								</div>
							</div>
